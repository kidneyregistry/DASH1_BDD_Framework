...
public class mayoMN_Intend {

	private WebDriver driver;
	// 1. By Locators: OR
				
				// 2. Constructor of the page class:
				public mayoMN_Intend(WebDriver driver) {
					this.driver = driver;
				}
				...
				public void RegistrationFormInfo() throws InterruptedException, IOException {
					...
					//https://mayomn.donorscreen.fail/register/now
					...
					WebElement ddown1 = driver.findElement(By.name("DonationType"));//Liver
				...
				public void QuestionaireInfo() throws InterruptedException, IOException {
					...
					driver.findElement(By.xpath("//input[@id='phoneNumber']")).sendKeys("7633072457");
					driver.findElement(By.xpath("//input[@id='PostalCode']")).sendKeys("55116");
					...
					WebElement ele3 = driver.findElement(By.xpath("//label[normalize-space()='Never']//input[@id='HistoryLiverDisease']")); 	//History of Liver diseasese
					ele3.click();
					WebElement ele30 = driver.findElement(By.xpath("//label[normalize-space()='Never']//input[@id='HasHepB']")); 	//History of Hepatitis B
					ele30.click();
					WebElement ele31 = driver.findElement(By.xpath("//label[normalize-space()='Never']//input[@id='HasHepC']")); 	//History of Hepatitis C
					ele31.click();
					driver.findElement(By.xpath("//button[@class='btn btn-primary btn-lg']")).click();//Continue
					...
					driver.findElement(By.xpath("//button[@class='btn btn-primary btn-lg']")).click();	//continue
					Thread.sleep(1000);
					WebElement rad3 = driver.findElement(By.xpath("//input[@id='hasIntendedRecipientYes']"));	//Has Intended-donation details
					rad3.click();
					
					WebElement ddown11 = driver.findElement(By.xpath("//select[@id='DdRelationshipToPatient']"));//How do you know your intended recipient?
					Select select111 = new Select(ddown11);
					select111.selectByIndex(7);
					Thread.sleep(500);
					//WebElement ddown111 = driver.findElement(By.xpath("//select[@id='DdHowCandidateFoundOut']"));//How did you find out about intended recipient?
					//Select select1111 = new Select(ddown111);
					//select1111.selectByIndex(8);
					//Thread.sleep(500);
					
					driver.findElement(By.xpath("//input[@id='DdRecipFirstName']")).sendKeys("Asia");//First Name
					driver.findElement(By.xpath("//input[@id='DdRecipLastName']")).sendKeys("Begum");//Last Name
					WebElement rad31 = driver.findElement(By.xpath("//*[@id=\"dd\"]/div[4]/div/label[2]"));//Recipient's birth date?
					rad31.click();
					//WebElement rad311 = driver.findElement(By.xpath("//label[normalize-space()='I do not know']//input[@id='CompatibilityStatus']")); //Compatible with the intended recipient?
					//rad311.click();
					driver.findElement(By.xpath("//label[normalize-space()='Yes']//input[@id='RecipientAtSameDashCenter']")).click();//Currently at our Transplant Center? YES, 
					//rad3111.click();
					...
					driver.findElement(By.xpath("//input[@id='addressLine1']")).sendKeys("1010 Bandana Boulevard W");
					driver.findElement(By.xpath("//input[@id='city']")).sendKeys("Saint Paul");
					
					WebElement droppdown = driver.findElement(By.xpath("//select[@id='state']"));
					Select select4 = new Select(droppdown);
					select4.selectByVisibleText("Minnesota");
					
					driver.findElement(By.xpath("//input[@name = 'PostalCode']")).sendKeys("55116");
					
					WebElement dropppdown = driver.findElement(By.xpath("//select[@id='Ethnicity']"));
					Select select5 = new Select(dropppdown);
					select5.selectByIndex(8);
					driver.findElement(By.xpath("//input[@id='Ssn']")).sendKeys("069459890");
					...
					driver.findElement(By.xpath("//input[@id='EmergencyContact']")).sendKeys("Henryana"); //Emergency Contact Name
					driver.findElement(By.xpath("//input[@id='EmergencyContactPhone']")).sendKeys("6516471637");	//Emergency Contact Number
					...
					driver.findElement(By.xpath("//input[@id = 'PhysicianName']")).sendKeys("Dr. Raj");	//Physician's Name
					driver.findElement(By.xpath("//input[@name = 'PhysicianCity']")).sendKeys("Saint Paul");		//Physician's City
					driver.findElement(By.xpath("//input[@id='PhysicianStateProvince']")).sendKeys("MN");		//Physician State
				   ...
				   /// links.size();
					...
					System.out.println("MayoMN Liver, HAS intended recipient, Testing is Complete.");
