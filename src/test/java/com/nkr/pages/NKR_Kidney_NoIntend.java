...
public class NKR_Kidney_NoIntend {
	...
	// 1. By Locators: OR
				...
				public NKR_Kidney_NoIntend(WebDriver driver) {
					this.driver = driver;
				}
				...
				public void RegistrationFormInfo() throws InterruptedException, IOException {
					...
					WebElement ddown = driver.findElement(By.xpath("//select[@name='PreferredLanguage']"));
				...
				public void QuestionaireInfo() throws InterruptedException, IOException {
					...
					driver.findElement(By.xpath("//input[@id='phoneNumber']")).sendKeys("3476534567");
					driver.findElement(By.xpath("//input[@id='PostalCode']")).sendKeys("11432");
					...
					WebElement ele27 = driver.findElement(By.xpath("//label[3]//input[1]"));//Do you want to Participate- I would like to learn
					ele27.click();
					...
					driver.findElement(By.xpath("//input[@id='addressLine1']")).sendKeys("89-19 171 St.");
					driver.findElement(By.xpath("//input[@id='city']")).sendKeys("Jamica");
					...
					driver.findElement(By.xpath("//input[@name = 'PhysicianCity']")).sendKeys("Jamaica");		//Physician's City
					driver.findElement(By.xpath("//input[@id='PhysicianStateProvince']")).sendKeys("NY");		//Physician State
					...
					System.out.println("No Intended Recipient Testing is complete.");
				}
}
