...
public class NoIntended_NKR_Kidney_StepDefinition {

	
	private NKR_Kidney_NoIntend NoIntend = new com.nkr.pages.NKR_Kidney_NoIntend(DriverFactory.getDriver());

	
	
		@Given("User goes to NKR_Kidney_No_Intneded_Recipient url {string}")
		public void user_goes_to_mayo_mn_liver_no_intneded_recipient_url(String URL) {
			DriverFactory.getDriver().get(URL);
		}

		@Given("User Enter Required Information for NKR_Kidney_No_Intneded_Recipient registration")
